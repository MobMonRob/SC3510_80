...
set_target_properties(3D-SensorSDK::MEGCPP PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/3D_Scanner/bin/libMEGCPP.so"
  IMPORTED_SONAME_RELEASE "libMEGCPP.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS 3D-SensorSDK::MEGCPP )
list(APPEND _IMPORT_CHECK_FILES_FOR_3D-SensorSDK::MEGCPP "${_IMPORT_PREFIX}/3D_Scanner/bin/libMEGCPP.so" )
